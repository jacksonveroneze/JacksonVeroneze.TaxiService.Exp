...
public sealed record RideResponse
{
    ...
    [JsonPropertyName("driver_id")] public Guid? DriverId { get; init; }

    [JsonPropertyName("fare")] public decimal? Fare { get; init; }

    [JsonPropertyName("distance")] public double? Distance { get; init; }

    [JsonPropertyName("from")] public CoordinateResponse? From { get; init; }

    [JsonPropertyName("to")] public CoordinateResponse? To { get; init; }

    [JsonPropertyName("status")] public RideStatus? Status { get; init; }
}
