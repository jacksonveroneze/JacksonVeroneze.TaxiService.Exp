...
using JacksonVeroneze.TaxiService.Exp.Domain.Specifications.Base.Predicate.Util;

namespace JacksonVeroneze.TaxiService.Exp.Domain.Specifications.Base.Predicate;
